...
describe("[Challenge] Side entrance", function () {
  ...
  it("Exploit", async function () {
    ...
    /**
     * The main idea here is to deposit the flashloan amount back into contract and them withdraw
     * everything to the attackers account
     */
    ...
    await sideEntranceAttacker.connect(attacker).executeFlashLoan();
  });
